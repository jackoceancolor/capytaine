...
# mesh convergence may be too fine for some very long cases like OSWEC and RM3
...
# # Multiple body cases ------------------------------------------------------#
print('Run Cubes case') # 11000 problems, 8.5 hours (b2b)
os.chdir("./Cubes")
import cubes

print('Run RM3 case') # 3380 problems, 21 hours (b2b)
os.chdir("../RM3")
import rm3

print('Run OSWEC case') # 11000 problems, 43 hours (b2b)
os.chdir("../OSWEC")
import oswec
